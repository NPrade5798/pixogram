	...
	ApplicationRunner init(UserRepo userRepo) {
		return args -> {
			Stream.of(new User("Deepa", "deepa@gmail.com", "deepa"), new User("Sahit", "sahit@gmail.com", "sahit"),
					...
					new User("Thangavel", "thangavel@gmail.com", "thangavel"), new User("Thaila", "thaila@gmail.com", "thaila"),
					new User("Vasanth", "vasanth@gmail.com", "vasanth"), new User("Siva", "siva@gmail.com", "siva"),
